...
<?php 
    ...
    if (isset($_POST["buton1"])) {
        ...
        $sql = "INSERT INTO ara1 (isim, fiyat, aciklama) VALUES ('$isim', '$fiyat', '$aciklama')";
...
<?php 
    ...
    if (isset($_POST["buton2"])) {
        ...
        // SQL sorgusunu hazırlayın
        $sql = "UPDATE ara1 SET isim='$yeniIsim', fiyat='$yeniFiyat', aciklama='$yeniAciklama' WHERE ID='$yeniID'";
...
<?php 
    ...
    if (isset($_POST["buton3"])) {
        ...
        // SQL sorgusunu hazırlayın
        $sql = "DELETE FROM ara1 WHERE ID='$silID'";
