...
<?php 
    ...
    if (isset($_POST["buton1"])) {
        ...
        $sql = "INSERT INTO ana1 (isim, fiyat, aciklama) VALUES ('$isim', '$fiyat', '$aciklama')";
...
<?php 
    ...
    if (isset($_POST["buton2"])) {
        ...
        // SQL sorgusunu hazırlayın
        $sql = "UPDATE ana1 SET isim='$yeniIsim', fiyat='$yeniFiyat', aciklama='$yeniAciklama' WHERE ID='$yeniID'";
...
<?php 
    ...
    if (isset($_POST["buton3"])) {
        ...
        // SQL sorgusunu hazırlayın
        $sql = "DELETE FROM ana1 WHERE ID='$silID'";
...
?>
    ...
    <div class="container-fluid">
        <main class="tm-main">
            ...
            <div class="row tm-row">
                <center>
            <h2 text-center >Ana Yemek Menüsü</h2>
                </center>
