    ...
    async getProducts() {
        try {
            if (this.products.length === 0) {
                let result = await fetch("https://64f988ed4098a7f2fc14903c.mockapi.io/products");
                if (!result.ok) {
            ...
            return this.products.filter(item => item.id > 24 && item.id <= 36);
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="product">
                    <div class="product-image">
                        <img src="${item.image}" alt="Ürün" class="img-fluid" />
                    </div>
        ...
        li.innerHTML = `
            <div class="cart-left">
                ...
                <div class="cart-left-info">
                    ...
                    <span class="cart-left-info-price">TL ${item.price}</span>
                </div>
            </div>
