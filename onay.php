...
// Formdan son eklenen siparişin ID'sini almak için bir SQL sorgusu hazırlanıyor
$sql = "SELECT * FROM siparisbilgi ORDER BY ID DESC LIMIT 1";
    ...
    echo '
        <div class="bg-dark">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">                     
                <div class="container">
                    <div class="text-center">
                        <i class="fas fa-check-circle fa-8x mb-3" style="color: #FEA116;"></i>
                        <h4 style="color: white;">Siparişiniz onaylanmıştır.</h4> 
                        <br>
                        <p style="color: white;">Sipariş Numarası: ' . $sonSiparisID . '</p>
                    </div>
                </div>
            </div>
        </div>';
} else {
    echo '<div class="alert alert-warning">Henüz sipariş kaydedilmemiş.</div>';
}
?>
